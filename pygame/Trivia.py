...
class Trivia(object):
    ...
    def show_question(self):
        ...
        print_text(font2, 20, 210, "1 - " + self.data[self.current + 1], red)
        print_text(font2, 20, 240, "2 - " + self.data[self.current + 2], red)
        print_text(font2, 20, 270, "3 - " + self.data[self.current + 3], red)
        print_text(font2, 20, 300, "4 - " + self.data[self.current + 4], red)
